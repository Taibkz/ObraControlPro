...
export default function MaterialesPage() {
  const { materials, suppliers, projects, addMaterial, deleteMaterial, addProjectMaterial } = useApp();
  ...
  // Cálculo en vivo del simulador rápido
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-2.5">
            ...
            <span>Catálogo de Materiales & Suministros</span>
          </h1>
          <p className="text-sm text-slate-500 mt-1">
            Gestiona tus materiales habituales (placas, perfiles, pastas, tornillería...) y simula presupuestos con el 5% de merma
          </p>
        </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="font-extrabold text-base text-white">
                Calculadora Rápida de Medición & Despiece
              </h2>
              <p className="text-xs text-slate-400">Aplica el +5% de merma y redondeo superior automático</p>
            </div>
          </div>
              ...
              {filteredMaterials.map(mat => (
                <tr key={mat.id} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="py-3.5 px-4 font-medium text-slate-600">
                    {mat.supplierName || 'Sin proveedor'}
                  </td>
          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden flex flex-col max-h-[92vh]">
            <div className="bg-slate-900 text-white px-5 py-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-base">Registrar Material en Catálogo</h3>
              </div>
            ...
            <form onSubmit={handleCreateMaterial} className="p-5 space-y-3 text-xs text-slate-700">
              <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  >
                    ...
                    <option value="Perfilería">Perfilería</option>
              ...
              <div>
                <label className="block font-bold text-slate-900 uppercase mb-1">Notas / Descripción</label>
                <input
                  type="text"
                  value={notes}
